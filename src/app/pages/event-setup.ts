                          ...
                          >
                            ...
                            <div class="relative">
                              ...
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M0.21967 0.21967C0.512563 -0.0732233 0.987437 -0.0732233 1.28033 0.21967L4.48866 3.428C4.78156 3.7209 4.78156 4.19577 4.48866 4.48866C4.19577 4.78156 3.7209 4.78156 3.428 4.48866L0.21967 1.28033C-0.0732233 0.987437 -0.0732233 0.512563 0.21967 0.21967Z" fill="#B1B1B1"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5C13.1421 16.5 16.5 13.1421 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5ZM0 9C0 4.02944 4.02944 0 9 0C13.9706 0 18 4.02944 18 9C18 13.9706 13.9706 18 9 18C4.02944 18 0 13.9706 0 9Z" fill="#B1B1B1"/>
                              </svg>
                            </div>
                          ...
                          >
                            <div class="grid grid-cols-[80px_1fr_200px_250px_120px] gap-4 items-center">
                              ...
                              <div class="flex items-center gap-3">
                                <!-- Mobile Icon -->
                                <svg
                                  *ngIf="webView.floorPlanTypes.includes('mobile')"
                                  width="22"
                                  height="22"
                                  viewBox="0 0 22 22"
                                  fill="none"
                                  xmlns="http://www.w3.org/2000/svg"
                                >
                                  <path d="M13.0156 1.83337H10.8156C10.5117 1.83337 10.2656 2.07941 10.2656 2.38337C10.2656 2.68733 10.5117 2.93337 10.8156 2.93337H13.0156C13.3196 2.93337 13.5656 2.68733 13.5656 2.38337C13.5656 2.07941 13.3196 1.83337 13.0156 1.83337Z" fill="black"/>
                                  <path d="M15.3984 0H6.59844C5.38552 0 4.39844 0.987078 4.39844 2.2V19.8C4.39844 21.0129 5.38552 22 6.59844 22H15.3984C16.6114 22 17.5984 21.0129 17.5984 19.8V2.2C17.5984 0.987078 16.6114 0 15.3984 0ZM16.4984 19.8C16.4984 20.4076 16.006 20.9 15.3984 20.9H6.59844C5.99086 20.9 5.49844 20.4076 5.49844 19.8V2.2C5.49844 1.59242 5.99086 1.1 6.59844 1.1H15.3984C16.006 1.1 16.4984 1.59242 16.4984 2.2V19.8Z" fill="black"/>
                                  <path d="M10.9984 20.1667C11.606 20.1667 12.0984 19.6742 12.0984 19.0667C12.0984 18.4592 11.606 17.9667 10.9984 17.9667C10.3909 17.9667 9.89844 18.4592 9.89844 19.0667C9.89844 19.6742 10.3909 20.1667 10.9984 20.1667Z" fill="black"/>
                                  <path d="M8.97969 2.93337C9.28344 2.93337 9.52969 2.68713 9.52969 2.38337C9.52969 2.07962 9.28344 1.83337 8.97969 1.83337C8.67593 1.83337 8.42969 2.07962 8.42969 2.38337C8.42969 2.68713 8.67593 2.93337 8.97969 2.93337Z" fill="black"/>
                                </svg>
                                <!-- Desktop Icon -->
                                <svg
                                  *ngIf="webView.floorPlanTypes.includes('desktop')"
                                  width="22"
                                  height="22"
                                  viewBox="0 0 22 22"
                                  fill="none"
                                  xmlns="http://www.w3.org/2000/svg"
                                >
                                  <path d="M21.5417 15.5833H20.1667V5.49997C20.1667 4.48888 19.3444 3.66663 18.3333 3.66663H3.66665C2.65555 3.66663 1.8333 4.48883 1.8333 5.49997V15.5833H0.458305C0.205004 15.5833 0 15.7883 0 16.0416V16.5C0 17.5111 0.822207 18.3333 1.83335 18.3333H20.1667C21.1778 18.3333 22 17.5111 22 16.5V16.0416C22 15.7883 21.795 15.5833 21.5417 15.5833ZM2.75 5.49997C2.75 4.99466 3.16134 4.58332 3.66665 4.58332H18.3333C18.8386 4.58332 19.25 4.99466 19.25 5.49997V15.5833H13.2917H8.70835H2.75V5.49997ZM20.1667 17.4166H1.83335C1.32804 17.4166 0.916695 17.0053 0.916695 16.5H2.2917H8.51855L8.84263 16.824C8.92856 16.91 9.04492 16.9583 9.1667 16.9583H12.8333C12.9551 16.9583 13.0715 16.91 13.1574 16.824L13.4814 16.5H19.7083H21.0833C21.0833 17.0053 20.672 17.4166 20.1667 17.4166Z" fill="black"/>
                                </svg>
                              </div>
                              <div class="flex items-center justify-center gap-2">
                                <!-- Edit Button -->
                                ...
                                >
                                  <svg
                                    ...
                                    xmlns="http://www.w3.org/2000/svg"
                                  >
                                    <path d="M19.1464 1.6403L19.1235 1.61951C18.6862 1.22003 18.1194 1 17.5273 1C16.8636 1 16.2264 1.28101 15.7789 1.77078L7.31849 11.0332C7.24136 11.1177 7.18293 11.2173 7.14673 11.3257L6.15188 14.308C6.03691 14.6528 6.09462 15.0342 6.30632 15.328C6.51965 15.6242 6.86345 15.801 7.22591 15.801C7.38265 15.801 7.53601 15.7688 7.68139 15.7052L10.5618 14.4451C10.6665 14.3993 10.7604 14.332 10.8375 14.2476L19.298 4.98517C20.1784 4.0214 20.1105 2.521 19.1464 1.6403Z" fill="white"/>
                                    <path d="M17.5065 8.53638C17.0553 8.53638 16.6896 8.90208 16.6896 9.35329V16.2886C16.6896 17.4341 15.7576 18.3661 14.6121 18.3661H4.71133C3.56571 18.3661 2.63379 17.4341 2.63379 16.2886V6.46827C2.63379 5.32266 3.56575 4.39074 4.71133 4.39074H11.8775C12.3287 4.39074 12.6944 4.02504 12.6944 3.57383C12.6944 3.12262 12.3287 2.75693 11.8775 2.75693H4.71133C2.66481 2.75693 1 4.42189 1 6.46827V16.2886C1 18.335 2.66485 19.9999 4.71133 19.9999H14.612C16.6584 19.9999 18.3233 18.335 18.3233 16.2886V9.35329C18.3234 8.90208 17.9576 8.53638 17.5065 8.53638Z" fill="white"/>
                                  </svg>
                                </button>
                                <!-- Delete Button -->
                                <button
                                ...
                                >
                                  <svg
                                    ...
                                    xmlns="http://www.w3.org/2000/svg"
                                  >
                                    <path d="M15.8359 5.83337C15.6149 5.83337 15.403 5.92117 15.2467 6.07745C15.0904 6.23373 15.0026 6.44569 15.0026 6.66671V15.9925C14.9787 16.4139 14.7892 16.8088 14.4755 17.0912C14.1618 17.3736 13.7492 17.5205 13.3276 17.5H6.6776C6.25602 17.5205 5.84342 17.3736 5.52969 17.0912C5.21596 16.8088 5.02651 16.4139 5.0026 15.9925V6.66671C5.0026 6.44569 4.91481 6.23373 4.75853 6.07745C4.60225 5.92117 4.39028 5.83337 4.16927 5.83337C3.94826 5.83337 3.7363 5.92117 3.58002 6.07745C3.42374 6.23373 3.33594 6.44569 3.33594 6.66671V15.9925C3.35972 16.8561 3.72476 17.675 4.35109 18.2699C4.97742 18.8648 5.814 19.1873 6.6776 19.1667H13.3276C14.1912 19.1873 15.0278 18.8648 15.6541 18.2699C16.2805 17.675 16.6455 16.8561 16.6673 15.9925V6.66671C16.6673 6.44569 16.5795 6.23373 16.4232 6.07745C16.2669 5.92117 16.0549 5.83337 15.8359 5.83337Z" fill="white"/>
                                    ...
                                    <path d="M12.5026 14.1667V8.33333C12.5026 8.11232 12.4148 7.90036 12.2585 7.74408C12.1022 7.5878 11.8903 7.5 11.6693 7.5C11.4483 7.5 11.2363 7.5878 11.08 7.74408C10.9237 7.90036 10.8359 8.11232 10.8359 8.33333V14.1667C10.8359 14.3877 10.9237 14.5996 11.08 14.7559C11.2363 14.9122 11.4483 15 11.6693 15C11.8903 15 12.1022 14.9122 12.2585 14.7559C12.4148 14.5996 12.5026 14.3877 12.5026 14.1667Z" fill="white"/>
                                  </svg>
                                </button>
                              </div>
                            </div>
